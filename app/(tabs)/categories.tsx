...
function Toast({
  ...
  return (
    ...
    >
      <Ionicons name="checkmark-circle" size={15} color={theme.accentLight} />
        ...
        {cats.length === 0 ? (
          <View style={styles.emptyState}>
            <View style={styles.emptyIconWrap}>
              ...
              <Ionicons name="grid-outline" size={44} color={theme.textTertiary} />
            </View>
              ...
              >
                ...
                <View style={styles.actions}>
                  <Pressable
                    ...
                    hitSlop={6}
                  >
                    <Ionicons name="create-outline" size={20} color={theme.primaryLight} />
                  </Pressable>
                  <Pressable
                    style={({ pressed }) => [styles.iconBtn, pressed && styles.iconBtnPressed]}
