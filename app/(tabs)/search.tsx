...
function ResultCard({ item, anim }: { item: LogResult; anim: Animated.Value }) {
  return (
    <Animated.View
      style={[
        styles.card,
      ...
      <View style={styles.cardBody}>
        ...
        <View style={styles.cardMeta}>
          ...
          <View style={[styles.catChipSmall, { backgroundColor: item.categoryColor + '20' }]}>
            <Text style={[styles.catChipText, { color: item.categoryColor }]}>
              {item.categoryName}
            </Text>
          </View>
        </View>
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <ResultCard item={item} anim={getCardAnim(item.logId)} />
        )}
        ListEmptyComponent={
          hasSearched ? (
            ...
            <View style={styles.promptState}>
              <View style={styles.emptyIconWrap}>
                <View style={styles.emptyGlow} />
                <Ionicons name="filter-outline" size={44} color={Colors.textTertiary} />
              </View>
